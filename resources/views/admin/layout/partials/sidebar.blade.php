          ...
          <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-desktop"></i> Master Data <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                ...
                <li><a href="/supplier">Data Pelanggan</a></li>
                <li><a href="/barang">Data Barang</a></li>
                <li><a href="/biaya">Data Biaya</a></li>
            ...
            <li><a><i class="fa fa-edit"></i> Service <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                ...
                <li><a href="/service">Service Masuk</a></li>
                <li><a href="/service">Service keluar</a></li>
              </ul>
            </li>
            <li><a><i class="fa fa-file"></i> Laporan <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                {{-- <li><a href="/admin/cetak-barang">Laporan Barang</a></li> --}}
                <li><a href="/admin/cetak-barang-masuk">Laporan Kendaraaan Masuk</a></li>
                <li><a href="/admin/cetak-barang-keluar">Laporan Kendaraan Keluar</a></li>
              </ul>
            </li>
            </ul>
        </div>
